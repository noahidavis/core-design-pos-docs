import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as i}from"./index-DmM0KDA7.js";import{K as c}from"./index-BEm4yTBR.js";import"./utils-mftCjzGE.js";import"./index-BDruVakc.js";import"./index-CeWxteyt.js";import"./index-BRMJmq_u.js";import"./index-CQvbv9qx.js";import"./index-CcsVPQhZ.js";import"./index-Cb2Qf4PO.js";const y={component:c,title:"Components/Keypad/Form",parameters:{backgrounds:{default:"dark"}}},n={args:{hasRecipient:!0},render:()=>{const[a,d]=i.useState(!0),[o,p]=i.useState(null),[s,l]=i.useState(null);return e.jsxs("div",{className:"p-24 space-y-32 text-white text-sm",children:[e.jsx(c,{hasRecipient:a,onInputChange:t=>{l(t)},onRequestSubmit:t=>{p(t)},buttonProps:{size:"bigAF"}}),e.jsxs("div",{className:"space-y-12",children:[e.jsxs("label",{children:[e.jsx("input",{type:"checkbox",checked:a,onChange:()=>d(t=>!t),className:"mr-8"}),"Recipient selected"]}),s&&e.jsxs("div",{children:[e.jsx("b",{children:"Live amount:"})," ",s.formatted," (",s.raw,")"]}),o!==null&&e.jsxs("div",{children:[e.jsx("b",{children:"Submitted amount:"})," $",o.toFixed(2)]})]})]})}};var r,m,u;n.parameters={...n.parameters,docs:{...(r=n.parameters)==null?void 0:r.docs,source:{originalSource:`{
  args: {
    hasRecipient: true
  },
  render: () => {
