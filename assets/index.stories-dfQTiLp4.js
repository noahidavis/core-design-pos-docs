import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{T as b}from"./index-CKryWnYU.js";import"./index-DmM0KDA7.js";import"./utils-mftCjzGE.js";import"./index-Cb2Qf4PO.js";import"./AlertCircleIcon-DpxqB1H-.js";const W={title:"Components/Global UI/Toast",component:b,parameters:{backgrounds:{default:"dark"}},decorators:[S=>o.jsx("div",{className:"flex flex-col min-h-[20dvh] items-center",children:o.jsx(S,{})})]},a={args:{variant:"neutral",visible:!0,message:{heading:"This is a toast"}}},s={args:{...a.args,message:{heading:"This is a toast",details:"These are details . . ."}}},e={args:{...a.args,variant:"loading",message:{heading:"This is another toast"}}},r={args:{...a.args,variant:"error",message:{heading:"This is another other toast"}}},t={args:{...a.args,variant:"positive",message:{heading:"This is another other toast's brother from a different mother"}}};var n,i,m;a.parameters={...a.parameters,docs:{...(n=a.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
    variant: "neutral",
    visible: true,
    message: {
...
}`,...(N=(x=t.parameters)==null?void 0:x.docs)==null?void 0:N.source}}};const C=["Neutral","With_Details","Loading","Error","Success"];export{r as Error,e as Loading,a as Neutral,t as Success,s as With_Details,C as __namedExportsOrder,W as default};
